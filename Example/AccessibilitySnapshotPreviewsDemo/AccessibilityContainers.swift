...
private struct ContainerTypeWrapper<Content: View>: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ContainerUIView {
        ...
        // The hosting controller is intentionally not adopted as a child VC: this representable
        // exists only to expose container-type accessibility metadata, and the snapshot pipeline
        // walks the view hierarchy directly without driving VC appearance callbacks.
...
private class ContainerUIView: UIView {
    ...
    override var accessibilityTraits: UIAccessibilityTraits {
        get { usesTabBarTrait ? super.accessibilityTraits.union(.tabBar) : super.accessibilityTraits }
