...
public struct AccessibilitySnapshotConfiguration {
    ...
    /// Whether to show container overlays (dashed borders around accessibility containers) and hierarchical legend. Defaults to `false`.
    ...
    ///   - showContainers: Whether to show container overlays and hierarchical legend. Defaults to `false`.
    public init(
