...
/// ```swift
/// element.description(context: context, verbosity: .minimal)  // Just the label
/// element.description(context: context, verbosity: .verbose)  // Everything (default)
/// ```
///
...
/// element.description(context: context, verbosity: config)
/// ```
